        ...
        <div class="header-right">
            <ul class="clearfix">
                <li class="icons dropdown"><a href="javascript:void(0)" data-toggle="dropdown">
                        ...
                        <span class="badge badge-pill gradient-1" style="top:-5.5px ;">3</span>
                    </a>
                ...
                <li class="icons dropdown"><a href="javascript:void(0)" data-toggle="dropdown">
                        ...
                        <span class="badge badge-pill gradient-2" style="top:-5px ;">3</span>
                    </a>
                ...
                <li class="icons dropdown">
                    ...
                    <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                        <div class="dropdown-content-body">
                            <ul>
                                <li><a href="/ARPLIFE/index.php"><i class=""></i> <span>Your Store</span></a></li>
                                <hr class="my-2">
                                <li>
