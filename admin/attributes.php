...
$query = "SELECT * from attributes_master , category_master , al_subcategory where am_categoryid=catm_categoryid and am_subcategoryid=sc_subcategoryid";
                                    ...
                                    <tbody>
                                        ...
                                        if ($rowcount > 0) {
                                            while ($getrows = mysqli_fetch_array($res)) { ?>
                                                <tr>
                                                    <td><input type="checkbox" class="attributeboxes" value="<?= $getrows['am_attributeid'] ?>" id="chk_attribute<?= $getrows['am_attributeid'] ?>"></td>
                                                    <td><?= $getrows['am_attributename'] ?></td>
                                                    <td><?= $getrows['catm_categoryname'] ?></td>
                                                    <td><?= $getrows['sc_subcategoryname'] ?> </td>
                                                    <td>
                                                        <a href="manage_attributes.php?attributeid=<?= $getrows['am_attributeid'] ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary">
