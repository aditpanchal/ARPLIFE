...
if(isset($_POST['brand_editbtn'])){
    ...
    $editbrand="UPDATE brand_master SET bm_brandname='$newbrand', bm_categoryid=$newcategory , bm_isactive=$newstatus WHERE bm_brandid=$brandid ";
    ...
    if (mysqli_num_rows($brandresult) > 0) {
        ...
        if($flag==0){
            $addbrand_query="insert into brand_master(bm_brandname , bm_categoryid , bm_isactive) values('$brand' , $category , $status)";
